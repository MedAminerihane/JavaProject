...
import edu.esprit.services.gestion.service.ServiceRemote;

public class ManageServicesDelegater {
	private static final String jndi = "/E-Goverment/EgovService!edu.esprit.services.gestion.service.ServiceRemote";
